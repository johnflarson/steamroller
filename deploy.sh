...
echo ""
echo "==> [1/4] Copying HTML5 build to Astro repo..."
...
# --- Step 2: Push builds to itch.io via butler ---
echo ""
echo "==> [2/4] Pushing builds to itch.io (${ITCH_USERNAME}/${GAME_SLUG})..."
...
# --- Step 3: Package builds for GitHub Release ---
echo ""
echo "==> [3/4] Packaging desktop builds for GitHub Release..."
...
echo ""
echo "==> [4/4] Creating GitHub Release ${VERSION}..."
git tag "${VERSION}"
